...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Шкафы стационарные двустворчатые</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick3.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Шкаф 2-х модульный, с металлическими дверями (с замком) и выдвижными ящиками; на высоких опорах. <br>
          Верхний модуль — 6-ти полочный с четырьмя регулируемыми полками с минимальным шагом 105 мм.<br>
          Нижний модуль — с 8-мью выдвижными ящиками (высота каждого — 240 мм) с шариковыми направляющими.<br>
          Распределенная нагрузка на каждый ящик — не более 10 кг<br>
          Ширина, мм — 880<br>
          Глубина, мм — 450<br>
          Высота, мм — 1970<br>
          Шкаф ШМ/Б5 кат. № 460 018 — сталь с полимерным покрытием
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">200</span> BYN / 1</h2>
