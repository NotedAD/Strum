...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Ширмы медицинские</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick15.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Ширма медицинская, выполнена в разборном варианте. <br>
          Длина, мм — 1000 мм <br>
          Ширина, мм — 420 мм <br>
          Высота, мм — 1700 мм<br>
          Ширма медицинская ШМ-1 кат. № 800 001<br>
          — каркас металлический с полимерным покрытием;<br>
          — полотно: ткань полиэстер.
          </p>
