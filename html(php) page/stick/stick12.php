...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Стеллажи медицинские</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick12.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Стеллаж пятиполочный. Номинальное межполочное расстояние — 465 мм.  <br>
          Нагрузка на полку — не более 80 кг.<br>
          Длина, мм — 1182<br>
          Ширина, мм — 557<br>
          Высота, мм — 2002<br>
          Стеллаж Т11.01 кат. № 700 001 — сталь с полимерным покрытием
          Стеллаж Т11.01 кат. № 700 002 — нержавеющая текстурированная сталь
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">100</span> BYN / 1</h2>
