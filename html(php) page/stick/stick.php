...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Столик врача</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick1.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Стол с 2-мя выдвижными ящиками и нишей. Внутренние размеры ящиков (высота наружных панелей ящиков — 120 мм): ширина — 399 мм; глубина — 395 мм; высота — 79 мм. Габаритные размеры ниши: ширина — 424 мм, глубина — 499 мм, высота — 102 мм. Стол снабжен столешницей, которая изготовлена из стекла толщиной 6 мм. В конструкции стола предусмотрено трехстороннее ограждение препятствующие падению со столешницы мелких предметов. Верхний ящик стола оснащен замком. Ящики комплектуются пластиковыми вкладышами (лотками). Стол оснащен колесными опорами Ø50 мм (две из них — с тормозом), не оставляющими следов на поверхности пола. <br>
          Ширина, мм — 500<br>
          Глубина, мм — 500<br>
          Высота, мм — 845<br>
          Стол C2H кат. № 350 011 — полимерное покрытие
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">80</span> BYN / 1</h2>
