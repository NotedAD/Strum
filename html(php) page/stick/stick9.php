...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Подставки медицинские</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick9.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Подставка для установки всех типоразмеров стерилизационных емкостей (биксов) и открытия крышек с помощью педального привода. Столик из нержавеющей текстурированной стали регулируется по высоте. <br>
          Длина, мм — 435<br>
          Ширина, мм — 500<br>
          Высота, мм — 1095<br>
          Подставка Т9.01 кат. № 600 002 <br>
          — сталь с полимерным покрытием<br>
          — столик — из нержавеющей текстурированной стали
          </p>
