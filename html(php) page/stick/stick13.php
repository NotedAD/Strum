...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Банкетки медицинские</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick13.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Банкетка на металлическом каркасе. <br>
          Длина, мм — 1500<br>
          Ширина, мм — 560<br>
          Ширина сидения, мм — 400<br>
          Высота, мм — 880<br>
          Банкетка БМ кат. № 752 000 — сидение и спинка — ДСП, пенополиуретан, винилискожа.
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">120</span> BYN / 1</h2>
