...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Столики врача передвижные</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick7.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Столик с 2-мя выдвижными ящиками (высота каждого — 120 мм) и съемным поддоном из нержавеющей текстурированной стали. Габариты поддона: 356 х 236 х 14 мм. Межполочное расстояние — 215 мм. <br>
          Ширина, мм — 450 <br>
          Глубина, мм — 450<br>
          Высота, мм — 835<br>
          Столик С2П кат. № 350 009 — сталь с полимерным покрытием
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">65</span> BYN / 1</h2>
