...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Тележки медицинские</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick11.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Тележка двухполочная, с колесными опорами ∅160 мм. Две колесные опоры поворотные с тормозом, две — неповоротные. Межполочное расстояние — 450 мм.
          Грузоподъемность — 60 кг на полку. <br>
          Длина, мм — 1180 <br>
          Ширина, мм — 660<br>
          Высота, мм — 1044<br>
          Габаритные размеры полок, мм — 1030 х 650<br>
          Тележка Т10.01 кат. № 650 001 — нержавеющая тексту∅рированная сталь
          </p>
