...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Кушетки медицинские</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick14.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Кушетка на металлическом каркасе. Подголовник регулируемый, 13-ти позиционный. Угол подъема — 0÷30°. <br>
          Длина, мм — 1950<br>
          Ширина, мм — 594<br>
          Высота, мм — 520<br>
          Кушетка КМ кат. № 751 000 — подголовник и лежак — ДСП, пенополиуретан, винилискожа
          </p>
