...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Тумбочки стационарные</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick5.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Тумбочка с пятью выдвижными ящиками (высота 60 мм — 2 шт., высота 120 мм — 2 шт., высота 362 мм — 1 шт.); столешница — ламинированный постформинг. <br>
          Ширина, мм — 480<br>
          Глубина, мм — 480 <br>
          Высота, мм — 880<br>
          Тумбочка Т5/Х кат. № 503 001 — сталь с полимерным покрытием
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">85</span> BYN / 1</h2>
