...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Столы медицинские</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick8.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Стол двухкорпусной. В одном корпусе 3 выдвижных ящика (высота 120 мм — 1 шт., высота 240 мм — 2 шт.). Второй корпус с тремя полками (две их них регулируемые). Столешница из ламинированного постформинга. <br>
          Габариты тумбы — 450 x 450 мм.<br>
          Длина, мм — 1810<br>
          Ширина, мм — 600 <br>
          Высота, мм — 760<br>
          Стол Т8.14 кат. № 550063 — сталь с полимерным покрытием
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">190</span> BYN / 1</h2>
