...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Стойки для аппаратуры</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick10.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Стойка для аппаратуры трехполочная, с колесами Ø 100 мм, два из которых — с тормозом. Стойка оснащена выдвижным ящиком (высота — 120 мм) на шариковых направляющих полного выдвижения. Габариты полки: 447 х 447 х 13 мм. Межполочное расстояние — 500 мм. Распределенная нагрузка на ящик — не более 10 кг. Распределенная нагрузка на каждую полку — не более 15 кг. <br>
          Длина, мм — 640<br>
          Ширина, мм — 530<br>
          Высота, мм — 1050<br>
          Стойка для аппаратуры СА.01 кат. № 100 001 — сталь с полимерным покрытием
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">90</span> BYN / 1</h2>
