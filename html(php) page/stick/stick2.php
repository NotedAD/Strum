...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Шкафы стационарные одностворчатые</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick2.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Шкаф 2-х модульный, с металлическими дверями (с замками). <br>
          Верхний модуль — 4-х полочный с 3-мя регулируемыми полками с шагом 140 мм; нижний — 2-х полочный с одной регулируемой полкой с шагом 105 мм.<br>
          Ширина, мм — 500<br>
          Глубина, мм — 450<br>
          Высота, мм — 1865<br>
          Шкаф ШМ/А1 кат. № 450 000 — сталь с полимерным покрытием
          Шкаф ШМ/А1 кат. № 450 015 — нержавеющая текстурированная сталь
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">130</span> BYN / 1</h2>
