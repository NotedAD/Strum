...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Шкафы навесные</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/stick4.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Шкаф 2-х полочный с одной регулируемой полкой; с металлическими дверями (с замком).<br>
          Ширина, мм — 1000 <br>
          Глубина, мм — 300 <br>
          Высота, мм — 460<br>
          Шкаф Н5/А кат. № 420 001 — сталь с полимерным покрытием
          Шкаф Н5/А кат. № 420 007 — нержавеющая сталь с полимерным покрытием
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">70</span> BYN / 1</h2>
