...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Инструмент для общей хирургии</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/product8.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
            Инструмент предназначен для захватывания и подачи стерильных инструментов и перевязочного материала, представляющий собой зажим с кремальерой, длинными изогнутыми браншами и овальными губками с насечкой.
            Инструмент представляет собой цельное изделие длиной 265мм, состоящее из длинных прямых браншей соединенных между собой.
            Рабочие части — длинные изогнутые бранши с овальными губками с насечкой
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">14</span> BYN / 1</h2>
