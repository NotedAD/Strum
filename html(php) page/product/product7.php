...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Инструменты для остеосинтеза</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/product7.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
            Отвертка для остеосинтеза
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">9</span> BYN / 1</h2>
