...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Cтоматологический инструмент</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/product1.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
            Зеркало стоматологическое предназначено для осмотра скрытых участков
            зуба и полости рта, отодвижения и защиты губ, щек и .языка,
            обеспечения дополнительного освещения затемненных участков зуба и
            полости рта, отражая свет стоматологического светильника Инструмент
            представляет собой сборное изделие, состоящее из зеркала
            стоматологического и шестигранной ручки для зеркала Зеркальный
            элемент диаметром 23 мм. Длина зеркала с ручкой – 158мм Угол наклона
            отражающей части относительно ручки зеркала составляет 138°. 3-х
            кратное увеличение по всей рабочей поверхности зеркала. Отражающая
            поверхность — боросиликатное стекло. Отражающий элемент обработан с
            двух сторон с высоким классом чистоты обработки поверхности.
            Минимальные краевые искажения. Высокий коэффициент отражения.
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">25</span> BYN / 1</h2>
