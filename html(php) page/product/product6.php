...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Минипластины и шурупы для остеосинтеза</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/product6.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Минипластины и шурупы для остеосинтеза
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">3</span> BYN / 1</h2>
