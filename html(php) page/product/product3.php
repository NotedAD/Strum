...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Инструмент для работы с металлокерамикой</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/product3.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          <p class="text-product">
          Инструмент моделировочный(инструмент для эстетической реставрации) предназначен для зуботехнических работ в процессе формовки композита, воска и керамического шликера.
          Инструмент представляет собой цельное изделие длиной 160мм, состоящее из шестигранной ручки и двух рабочих частей(закругленных штопферов разной толщины).<br>
          Первая рабочая часть в виде закругленного штопфера — ф0,6 мм<br>
          Вторая рабочая часть в виде закругленного штопфера — ф0,8 мм
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">2</span> BYN / 1</h2>
