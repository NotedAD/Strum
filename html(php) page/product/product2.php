...
<div class="menu-burger__header">
    ...
    <main id="main">
      <h2 class="header-text" id="name-tool">Гильза для зубной коронки</h2>
      <div class="product-box">
        <div>
          <img src="../../img/product/product2.jpg" alt="Продукт" />
        </div>
        <div class="info-product">
          ...
          040-011 № 8 (D = 8 мм) <br>
          040-012 № 9 (D = 9 мм) <br>
          040-013 № 10 (D = 10 мм) <br>
          040-015 № 12 (D = 12 мм) <br>
          040-018 № 14,5 (D = 14,5 мм)
          </p>
          <div class="message-box"></div>
          <div class="order">
            <h2 class="price">Цена: <span id="price-on-ed">0.30</span> BYN / 1</h2>
